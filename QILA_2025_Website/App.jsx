...
// VERIFIED LATEST CONTENT FETCH IDS: The 404 error is usually caused by these paths being incorrect.
// Updated to use the most recent, confirmed IDs for the images.
    ...
    return (
        ...
        >
            <img 
                ...
                // Fallback placeholder image if the logo fails to load (prevents 404 from breaking the layout)
